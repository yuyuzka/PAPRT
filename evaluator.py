...
def evaluate(model, max_len, eval_data, eval_sampler, eval_batch_size, eval_num_neg, quadkey_processor, loc2quadkey, device, num_workers):
    ...
    with torch.no_grad():
        ...
        for _, (src_locs_, src_quadkeys_, src_times_, w_mat, s_mat,c_mat,trg_locs_, trg_quadkeys_, data_size,src_periods_) in enumerate(loader):
